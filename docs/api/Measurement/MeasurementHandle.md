<a name="MeasurementHandle"></a>

### MeasurementHandle 

**Extends**: <code>[ScreenSpaceMovementHandle](api/Handles\ScreenSpaceMovementHandle.md)</code>  

* [MeasurementHandle ⇐ <code>ScreenSpaceMovementHandle</code>](#MeasurementHandle)
    * [handlePointerMove(event) ⇒ <code>boolean</code>](#handlePointerMove)
    * [onDragStart(event)](#onDragStart)
    * [onDrag(event)](#onDrag)
    * [onDragEnd(event)](#onDragEnd)

<a name="MeasurementHandle+handlePointerMove"></a>
