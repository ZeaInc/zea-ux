[@zeainc/zea-ux](../API.md) / CreateSphereTool

# Class: CreateSphereTool
...
- [constructor](CreateSphereTool.md#constructor)

### Properties

- [\_\_activeController](CreateSphereTool.md#__activecontroller)
- [appData](CreateSphereTool.md#appdata)
- [change](CreateSphereTool.md#change)
- [colorParam](CreateSphereTool.md#colorparam)
- [constructionPlane](CreateSphereTool.md#constructionplane)
- [parentItem](CreateSphereTool.md#parentitem)
- [prevCursor](CreateSphereTool.md#prevcursor)
- [radius](CreateSphereTool.md#radius)
- [removeToolOnRightClick](CreateSphereTool.md#removetoolonrightclick)
- [stage](CreateSphereTool.md#stage)
- [vrControllerToolTip](CreateSphereTool.md#vrcontrollertooltip)
- [vrControllerToolTipMat](CreateSphereTool.md#vrcontrollertooltipmat)
- [xfo](CreateSphereTool.md#xfo)

### Methods

- [activateTool](CreateSphereTool.md#activatetool)
- [addIconToVRController](CreateSphereTool.md#addicontovrcontroller)
- [controllerAddedHandler](CreateSphereTool.md#controlleraddedhandler)
- [createMove](CreateSphereTool.md#createmove)
- [createPoint](CreateSphereTool.md#createpoint)
- [createRelease](CreateSphereTool.md#createrelease)
- [createStart](CreateSphereTool.md#createstart)
- [deactivateTool](CreateSphereTool.md#deactivatetool)
- [onKeyDown](CreateSphereTool.md#onkeydown)
- [onKeyPressed](CreateSphereTool.md#onkeypressed)
- [onKeyUp](CreateSphereTool.md#onkeyup)
- [onPointerDown](CreateSphereTool.md#onpointerdown)
- [onPointerMove](CreateSphereTool.md#onpointermove)
- [onPointerUp](CreateSphereTool.md#onpointerup)
- [onTouchCancel](CreateSphereTool.md#ontouchcancel)
- [onVRControllerButtonDown](CreateSphereTool.md#onvrcontrollerbuttondown)
- [onVRControllerButtonUp](CreateSphereTool.md#onvrcontrollerbuttonup)
- [onVRPoseChanged](CreateSphereTool.md#onvrposechanged)
- [onWheel](CreateSphereTool.md#onwheel)
- [screenPosToXfo](CreateSphereTool.md#screenpostoxfo)

## Constructors

### constructor

• **new CreateSphereTool**(`appData`)
...
[src/Tools/CreateTools/CreateSphereTool.ts:24](https://github.com/ZeaInc/zea-ux/blob/8c31065/src/Tools/CreateTools/CreateSphereTool.ts#L24)
...
• **change**: [`CreateSphereChange`](CreateSphereChange.md)

#### Defined in

[src/Tools/CreateTools/CreateSphereTool.ts:16](https://github.com/ZeaInc/zea-ux/blob/8c31065/src/Tools/CreateTools/CreateSphereTool.ts#L16)
...
[src/Tools/CreateTools/CreateSphereTool.ts:18](https://github.com/ZeaInc/zea-ux/blob/8c31065/src/Tools/CreateTools/CreateSphereTool.ts#L18)
...
[src/Tools/CreateTools/CreateSphereTool.ts:17](https://github.com/ZeaInc/zea-ux/blob/8c31065/src/Tools/CreateTools/CreateSphereTool.ts#L17)
...
[src/Tools/CreateTools/CreateSphereTool.ts:50](https://github.com/ZeaInc/zea-ux/blob/8c31065/src/Tools/CreateTools/CreateSphereTool.ts#L50)
...
[src/Tools/CreateTools/CreateSphereTool.ts:60](https://github.com/ZeaInc/zea-ux/blob/8c31065/src/Tools/CreateTools/CreateSphereTool.ts#L60)
...
[src/Tools/CreateTools/CreateSphereTool.ts:33](https://github.com/ZeaInc/zea-ux/blob/8c31065/src/Tools/CreateTools/CreateSphereTool.ts#L33)
