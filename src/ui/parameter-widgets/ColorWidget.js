  ...
  constructor(parameter, parentDomElem){
    ...
    parameter.valueChanged.connect(()=>{
      if(!change){
        ...
        colorPicker.color.rgb = { r: col.r*255, g: col.g*255, b: col.b*255 };
      }
    });
    ...
    colorPicker.on('color:change', (color, changes)=>{
      ...
      change.setValue(new Visualive.Color(rgb.r/255, rgb.g/255, rgb.b/255))
    });
  }
...
parameterWidgetFactory.registerWidget(ColorWidget, (p) => p.constructor.name == 'ColorParameter')