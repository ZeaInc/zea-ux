...
describe('Planar Movement Handle', () => {
  ...
  it('Planar Movement Handle Moves - Mouse', () => {
    ...
    canvas.trigger('mousedown', 500, 300).trigger('mousemove', 500, 350).trigger('mouseup', 500, 350)
    canvas.percySnapshot('PlanarMovementHandleMovesMouse')
  })
  ...
  it('Planar Movement Handle Moves - Touch', () => {
    ...
    canvas.percySnapshot(`PlanarMovementHandleMovesTouch`)
  })
})
